...
import adminPanelEntryRoutes from "./routes/adminPanelEntry";
...
import dayzItemImageAdminRoutes from "./routes/dayzItemImageAdmin";
...
app.use("/admin-panel/system/dayz-images", dayzItemImageAdminRoutes);
app.use("/admin-panel", adminPanelEntryRoutes);
