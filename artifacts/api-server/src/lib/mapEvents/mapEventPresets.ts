...
export const mapEventPresets: MapEventPreset[] = [
  ...
  },
  {
    ...
    name: "Airdrop — Militar com fumaça",
    description: "Drop militar com container, fumaça de helicrash, infectados e loot físico em grupo.",
    imageUrl: "https://www.dayztools.de/itemdb2/icons/Land_Container_1Moh_DE.png",
    eventTypeLabel: "Airdrop",
    lootTypeLabel: "Militar com fumaça",
    colorLabel: "Smoke",
