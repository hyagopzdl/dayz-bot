  ...
  <script>
    ...
    function renderServiceSettings() {
      ...
      if (metrics && state.persistenceMetrics) {
        ...
        '<div class="settings-note" style="margin-top:12px">Safety: Phase 7 namespaces the active execution context, in-memory state cache and ADM downloader strategy without moving the PZ ADM cache or starting a second scheduler. A second server remains blocked until the activation/onboarding phase.</div></div>' +
